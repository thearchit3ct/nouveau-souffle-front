...
import { Shield, LayoutDashboard, CreditCard, Heart, Calendar, FileText, Users, FolderOpen, Tag, HandHelping, FileDown, GraduationCap, MapPin, Loader2 } from 'lucide-react';
...
const adminNav = [
  ...
  { name: 'Maraudes', href: '/admin/maraudes', icon: MapPin },
];
